...
unsigned long long mark_reach_counts = 0;
unsigned long long mark_reach_cycles = 0;
unsigned long long mark_reach_while_counts = 0;
unsigned long long mark_reach_stone_counts = 0;

unsigned long long moves_counts = 0;
unsigned long long moves_cycles = 0;
unsigned long long moves_while_counts = 0;
...
void PrintExperimentsStats() {
  ...
  Mprintf(1, "Total number of stones for MarkReach(): %llu\n", mark_reach_stone_counts);
  Mprintf(1, "Average stones for MarkReach(): %llu\n", mark_reach_stone_counts / (double)mark_reach_stone_counts);
